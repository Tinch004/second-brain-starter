...
- **Ejemplo** — Además del audit manual (paso 6), un CI (`.github/workflows/vault-audit.yml`) corre el mismo chequeo de huérfanas/links rotos/nombres inválidos en cada push — cubre también un commit hecho a mano desde Obsidian, sin agente de por medio.
