...
2. Si hace falta más detalle: `{{proyecto}}-todos.md` (tareas activas), `{{proyecto}}-decisions.md` (por qué se decidió algo), `{{proyecto}}-context.md` (log de sesiones anteriores) — en ese orden, solo si la tarea lo exige (ver "Cómo orientarte (recuperación en capas: L0-L3)" en la skill).
